...
namespace HotAssembly
{
    ...
    public abstract class LoopScrollRectBase : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        protected List<UIItemBase> items = new List<UIItemBase>();
        ...
        protected abstract void ProvideData(UIItemBase item, int index);
        ...
        protected float NewItemAtStart(bool includeSpacing = true)
        {
            ...
            {
                itemTypeStart--;
                UIItemBase newItem = GetFromTempPool(itemTypeStart);
        ...
        protected float NewItemAtEnd(bool includeSpacing = true)
        {
            ...
            {
                UIItemBase newItem = GetFromTempPool(itemTypeEnd);
        ...
        protected void SetSiblingIndex(UIItemBase item, int insert)
        {
            if (insert < 0)
            {
                items.Add(item);
        ...
        protected abstract UIItemBase GetFromTempPool(int itemIdx);
