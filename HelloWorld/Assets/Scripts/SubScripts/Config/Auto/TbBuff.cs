...
public partial class TbBuff
{
    ...
    {
        int n = _buf.ReadSize();
        _dataMap = new System.Collections.Generic.Dictionary<int, Buff>(n);
        _dataList = new System.Collections.Generic.List<Buff>(n);
        for(int i = n ; i > 0 ; --i)
        {
            Buff _v;
            _v = global::cfg.Buff.DeserializeBuff(_buf);
            _dataList.Add(_v);
