...
public partial class UITestComponent
{
    ...
    public void Init(GameObject obj)
    {
        ...
        imageUIImage = allData[21].exportComponent[0] as UIImage;
        uIProcessBtnUIButton = allData[22].exportComponent[0] as UIButton;
        subRootObj = allData[23].gameObject;
        loopLoopListView2 = allData[24].exportComponent[0] as SuperScrollView.LoopListView2;
        itemLoopListViewItem2 = allData[25].exportComponent[0] as SuperScrollView.LoopListViewItem2;
        functionObj = allData[27].gameObject;
        openSDKBtnUIButton = allData[28].exportComponent[0] as UIButton;
        coroutineBtnUIButton = allData[29].exportComponent[0] as UIButton;
        addTriggerBtnUIButton = allData[30].exportComponent[0] as UIButton;
        excuteTriggerBtnUIButton = allData[31].exportComponent[0] as UIButton;
        guideUIButton = allData[32].exportComponent[0] as UIButton;
        serializeUIButton = allData[33].exportComponent[0] as UIButton;
        deserializeUIButton = allData[34].exportComponent[0] as UIButton;
        miniGameObj = allData[35].gameObject;
        createAdBtnUIButton = allData[36].exportComponent[0] as UIButton;
        showAdBtnUIButton = allData[37].exportComponent[0] as UIButton;
        showAdVideoBtnUIButton = allData[38].exportComponent[0] as UIButton;
        uploadRankDataBtnUIButton = allData[39].exportComponent[0] as UIButton;
        openRankBtnUIButton = allData[40].exportComponent[0] as UIButton;
        openMenuBtnUIButton = allData[41].exportComponent[0] as UIButton;
        rankObj = allData[42].gameObject;
        rankRawImage = allData[42].exportComponent[1] as UnityEngine.UI.RawImage;
        rankRectTransform = allData[42].exportComponent[2] as UnityEngine.RectTransform;
    }
}
