...
public partial class UITestComponent
{
    ...
    public void Init(GameObject obj)
    {
        ...
        openSubBtnUIButton = allData[19].exportComponent[0] as UIButton;
        openMsgBtnUIButton = allData[20].exportComponent[0] as UIButton;
        openTipsBtnUIButton = allData[21].exportComponent[0] as UIButton;
        loadSpriteUIButton = allData[22].exportComponent[0] as UIButton;
        imageUIImage = allData[23].exportComponent[0] as UIImage;
        uIProcessBtnUIButton = allData[24].exportComponent[0] as UIButton;
        ...
        functionObj = allData[29].gameObject;
        openSDKBtnUIButton = allData[30].exportComponent[0] as UIButton;
        coroutineBtnUIButton = allData[31].exportComponent[0] as UIButton;
        addTriggerBtnUIButton = allData[32].exportComponent[0] as UIButton;
        excuteTriggerBtnUIButton = allData[33].exportComponent[0] as UIButton;
        guideUIButton = allData[34].exportComponent[0] as UIButton;
        serializeUIButton = allData[35].exportComponent[0] as UIButton;
        deserializeUIButton = allData[36].exportComponent[0] as UIButton;
        miniGameObj = allData[37].gameObject;
        createAdBtnUIButton = allData[38].exportComponent[0] as UIButton;
        showAdBtnUIButton = allData[39].exportComponent[0] as UIButton;
        showAdVideoBtnUIButton = allData[40].exportComponent[0] as UIButton;
        uploadRankDataBtnUIButton = allData[41].exportComponent[0] as UIButton;
        openRankBtnUIButton = allData[42].exportComponent[0] as UIButton;
        openMenuBtnUIButton = allData[43].exportComponent[0] as UIButton;
        rankObj = allData[44].gameObject;
        rankRawImage = allData[44].exportComponent[1] as UnityEngine.UI.RawImage;
        rankRectTransform = allData[44].exportComponent[2] as UnityEngine.RectTransform;
    }
}
