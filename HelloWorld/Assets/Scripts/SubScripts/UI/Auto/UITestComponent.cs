...
public partial class UITestComponent
{
    ...
    public void Init(GameObject obj)
    {
        ...
        sceneObj = allData[8].gameObject;
        openTestSceneUIButton = allData[9].exportComponent[0] as UIButton;
        closeTestSceneUIButton = allData[10].exportComponent[0] as UIButton;
        poolEnqueueUIButton = allData[11].exportComponent[0] as UIButton;
        poolDequeueUIButton = allData[12].exportComponent[0] as UIButton;
        openBattleSceneUIButton = allData[13].exportComponent[0] as UIButton;
        closeBattleSceneUIButton = allData[14].exportComponent[0] as UIButton;
        openRvoSceneUIButton = allData[15].exportComponent[0] as UIButton;
        closeRvoSceneUIButton = allData[16].exportComponent[0] as UIButton;
        openInfiniteTerrainSceneUIButton = allData[17].exportComponent[0] as UIButton;
        closeInfiniteTerrainSceneUIButton = allData[18].exportComponent[0] as UIButton;
        uIObj = allData[19].gameObject;
        openSubBtnUIButton = allData[20].exportComponent[0] as UIButton;
        openMsgBtnUIButton = allData[21].exportComponent[0] as UIButton;
        openTipsBtnUIButton = allData[22].exportComponent[0] as UIButton;
        loadSpriteUIButton = allData[23].exportComponent[0] as UIButton;
        imageUIImage = allData[24].exportComponent[0] as UIImage;
        ...
        rankObj = allData[29].gameObject;
        rankRawImage = allData[29].exportComponent[1] as UnityEngine.UI.RawImage;
        rankRectTransform = allData[29].exportComponent[2] as UnityEngine.RectTransform;
