...
public partial class UITestComponent
{
    ...
    public UIButton cameraTRSUIButton = null;
    ...
    public void Init(GameObject obj)
    {
        ...
        cameraTRSUIButton = allData[16].exportComponent[0] as UIButton;
        uIObj = allData[17].gameObject;
        openSubBtnUIButton = allData[18].exportComponent[0] as UIButton;
        openMsgBtnUIButton = allData[19].exportComponent[0] as UIButton;
        openTipsBtnUIButton = allData[20].exportComponent[0] as UIButton;
        loadSpriteUIButton = allData[21].exportComponent[0] as UIButton;
        uIProcessBtnUIButton = allData[22].exportComponent[0] as UIButton;
        commonItemBtnUIButton = allData[23].exportComponent[0] as UIButton;
        languageBtnUIButton = allData[24].exportComponent[0] as UIButton;
        subRootObj = allData[25].gameObject;
        loopLoopListView2 = allData[26].exportComponent[0] as SuperScrollView.LoopListView2;
        itemLoopListViewItem2 = allData[27].exportComponent[0] as SuperScrollView.LoopListViewItem2;
        imageImage = allData[29].exportComponent[0] as UnityEngine.UI.Image;
        itemRootObj = allData[30].gameObject;
        languageUIText = allData[31].exportComponent[0] as UIText;
        functionObj = allData[32].gameObject;
        openSDKBtnUIButton = allData[33].exportComponent[0] as UIButton;
        coroutineBtnUIButton = allData[34].exportComponent[0] as UIButton;
        addTriggerBtnUIButton = allData[35].exportComponent[0] as UIButton;
        excuteTriggerBtnUIButton = allData[36].exportComponent[0] as UIButton;
        guideUIButton = allData[37].exportComponent[0] as UIButton;
        serializeUIButton = allData[38].exportComponent[0] as UIButton;
        deserializeUIButton = allData[39].exportComponent[0] as UIButton;
        miniGameObj = allData[40].gameObject;
        createAdBtnUIButton = allData[41].exportComponent[0] as UIButton;
        showAdBtnUIButton = allData[42].exportComponent[0] as UIButton;
        showAdVideoBtnUIButton = allData[43].exportComponent[0] as UIButton;
        uploadRankDataBtnUIButton = allData[44].exportComponent[0] as UIButton;
        openRankBtnUIButton = allData[45].exportComponent[0] as UIButton;
        openMenuBtnUIButton = allData[46].exportComponent[0] as UIButton;
        rankObj = allData[47].gameObject;
        rankRawImage = allData[47].exportComponent[1] as UnityEngine.UI.RawImage;
        rankRectTransform = allData[47].exportComponent[2] as UnityEngine.RectTransform;
    }
}
